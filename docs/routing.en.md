...
The model catalog is not part of the router snapshot. The gateway reads `model_catalog_json` when handling `/v1/models` and request model resolution, mapping exposed names to upstream models.
